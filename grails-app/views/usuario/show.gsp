			...
			<ol class="property-list usuario">
                ...
                <g:if test="${usuarioInstance?.creditcard}">
                    <li class="fieldcontain">
                        ...
                        <span class="property-value" aria-labelledby="creditcard-label"><g:fieldValue
                                bean="${usuarioInstance}" field="creditcard" format="*****"/></span>
                ...
                <g:if test="${usuarioInstance?.subscripcion}">
                    <li class="fieldcontain">
                        <span id="subscripcion-label" class="property-label"><g:message
                                code="usuario.subscripcion.label" default="Subscripcion"/></span>
